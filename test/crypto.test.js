...
test('crypto.generateKeys', function(t) {
  ...
  t.equal(keys.public.slice(0, 3), 'SCP', 'generated public key is in scoop format');
...
test('crypto.keysFromPassword', function(t) {
  ...
  var publicKeys = [
    ['owner', 'SCP5pZ15FDVAvNKW3saTJchWmSSmYtEvA6aKiXwDtCq2JRZV9KtR9'],
    ['memo', 'SCP5nwJgD9jmkAdTXuiz3jqrkw3om95gCapZo4e4Bcp3qzyiedwCn'],
    ['active', 'SCP5SKxjN1YdrFLgoPcp9KteUmNVdgE8DpTPC9sF6jbjVqP9d2Utq'],
    ['posting', 'SCP6gZmazY23TEMkxmPpnmvbAgWFAzwtaSDbhSUdmpTXzoJJLPFH4']
  ];
...
test('crypto.PrivateKey', function(t) {
  ...
  t.equal(
    pub.toString(),
    'SCP5SKxjN1YdrFLgoPcp9KteUmNVdgE8DpTPC9sF6jbjVqP9d2Utq',
...
test('crypto.PublicKey', function(t) {
  var priv = crypto.PrivateKey.from('5JamTPvZyQsHf8c2pbN92F1gUY3sJkpW3ZJFzdmfbAJPAXT5aw3');
  var pub = crypto.PublicKey.from('SCP5SKxjN1YdrFLgoPcp9KteUmNVdgE8DpTPC9sF6jbjVqP9d2Utq');
